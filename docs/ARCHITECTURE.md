...
Source of truth: `docs/ARCHITECTURE.yaml`. Tracking: [Project #24](https://github.com/users/googa27/projects/24), [PSC-cubesat issue](https://github.com/googa27/PSC-cubesat/issues/1). Profile: `legacy`; enforcement: `Advisory`.
...
- AI: Minimal AGENTS documenting hardware/document safety and runnable scripts; no MCP/plugin.
- Human/notebook: No notebook/package API mandate until revival; preserve hardware semantics and reproducible scripts.
- Planned Python protocols: No Python dunder surface is planned for the hardware/docs reference; future telemetry types require a separate typed architecture decision.
- Core posture: No finance core coupling.
- Data posture: Telemetry/document sources require schema/provenance plan only upon revival.
